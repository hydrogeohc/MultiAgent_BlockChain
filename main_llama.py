...
# Initialize LLM with Llama 3.2
llm = LLM(model = AutoModelForCausalLM.from_pretrained("meta-llama/Llama-3.2-3B-Instruct"))

# The rest of the code (defining tool classes, agents, tasks, and crew) remains the same.
# Only the LLM initialization has changed.
